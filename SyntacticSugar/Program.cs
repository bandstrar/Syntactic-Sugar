...
namespace SyntacticSugar
{
    ...
    class Program
    {
        private const string V = "Eagle";

        static void Main(string[] args)
        {
            Bug mantis = new Bug("Scyther", "Praying Mantis", new List<string> { "Eagle", "Praying Mantis", "Crab" }, new List<string> { "Praying Mantis", "Beetle", "Ladybug" });
